...
local WorldConfig = {
	...
	Zones = {
		zone("stromblad-estate", "Stromblad Estate", Vector3.new(-260, 0, -300), Vector3.new(190, 2, 180), {
			...
			Category = "Venue",
			ZoneType = "Active",
			HubSignOffset = Vector3.new(-112, 0, -112),
			HubPadOffset = Vector3.new(-62, 0, -62),
			HubBoardLabel = "Estate",
			ShortLabel = "Estate",
		...
		zone("founder-lounge", "Founder Lounge", Vector3.new(320, 0, 180), Vector3.new(188, 2, 168), {
			...
			Category = "Venue",
			ZoneType = "Active",
			HubSignOffset = Vector3.new(110, 0, 114),
			HubPadOffset = Vector3.new(76, 0, 46),
		...
		zone("bo6-gaming-lounge", "BO6 Gaming Lounge", Vector3.new(-360, 0, -40), Vector3.new(196, 2, 168), {
			...
			Category = "Venue",
			ZoneType = "Active",
			HubSignOffset = Vector3.new(-130, 0, 6),
			HubPadOffset = Vector3.new(-90, 0, 0),
			HubBoardLabel = "BO6",
			ShortLabel = "BO6",
