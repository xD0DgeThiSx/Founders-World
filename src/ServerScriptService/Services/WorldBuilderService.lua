...
local function buildFounderPlaza(plazaFolder, navigationFolder, spawnFolder)
	...
	local centralSpawn = createSpawn(spawnFolder, "CentralSpawn", hub.SpawnPosition, Color3.fromRGB(255, 201, 68))
	centralSpawn.CFrame = CFrame.new(hub.SpawnPosition) * CFrame.Angles(0, math.rad(180), 0)
